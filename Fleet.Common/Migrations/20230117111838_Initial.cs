        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Company = table.Column<string>(type: "nvarchar(127)", maxLength: 127, nullable: false),
                    Name = table.Column<string>(type: "nvarchar(31)", maxLength: 31, nullable: false),
                    Logo = table.Column<byte[]>(type: "varbinary(max)", maxLength: 1048576, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Acronym = table.Column<string>(type: "nvarchar(31)", maxLength: 31, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(127)", maxLength: 127, nullable: false),
                    TechnicalName = table.Column<string>(type: "nvarchar(31)", maxLength: 31, nullable: false),
                    VehicleModelId = table.Column<int>(type: "int", nullable: false),
                    Enabled = table.Column<bool>(type: "bit", nullable: false),
                    BodySpecs = table.Column<string>(type: "nvarchar(max)", nullable: false),
