...
public abstract partial class NotifyDataErrorInfo<T> : DisposableObservableObject, INotifyDataErrorInfo
    where T : NotifyDataErrorInfo<T>
{
    ...
    protected override void OnPropertyChanged(PropertyChangedEventArgs e)
    {
        ...
        {
            this.ApplyRules(e.PropertyName);
        }
