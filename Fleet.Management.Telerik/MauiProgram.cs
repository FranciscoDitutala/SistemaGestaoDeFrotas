    ...
    public static class MauiProgram
    {
        public static MauiApp CreateMauiApp()
        {
           ...
           // string PartsBaseAddress = "http://172.16.33.154:5124"; //TODO: Get from Configuration in production
            ...
            //string CommonBaseAddress = "http://192.168.0.111:5107"; //TODO: Get from Configuration in production
            //string PartsBaseAddress = "http://192.168.0.111:5124"; //TODO: Get from Configuration in production
            ...
            builder.Services.AddTransient<StockEntryViewModel>();
            builder.Services.AddTransient<StockEntryPage>();

            builder.Services.AddSingleton<StockOutsViewModel>();
            builder.Services.AddSingleton<StockOutsPage>();

            builder.Services.AddTransient<StockOutViewModel>();
